...
def receive_text():
    ...
    try:
        ...
        template = """Analyze the content of the provided text and generate insights. Include a summary (200 characters) and a detailed description (1500 characters). Output the response in JSON format structured as follows without JSON headers:
        ...
        for index, insight in enumerate(insights, start=1):
            formatted_insights[f"Insight{index}"] = {
